...
public class PresenceFootsteps implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        keyBinding = KeyBindingHelper.registerKeyBinding(new KeyMapping("key.presencefootsteps.settings", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_F10, "key.categories.misc"));
